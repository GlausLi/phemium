...
- (void)setExtraSettings: (NSString *)extraSettings {
    ...
    use_callkit = [[extraSettings valueForKey:@"use_callkit"] boolValue];
    
    if ([extraSettings valueForKey:@"log_mode"] != nil) {
        log_enable = [[extraSettings valueForKey:@"log_mode"] boolValue];
    }
}
