...
- (void)sendLinphoneDebug{
    if (currentCallData.log_enable) {
        if ([MFMailComposeViewController canSendMail]) {
            ...
            [mailer addAttachmentData:exportFileData mimeType:@"text/plain" fileName:@"phemiumvideocall.log"];
            NSString * emailBody = @"Phemium Videocall Log file attached";
